...
int flag_Primo=0;
int flag_Ultimo=0;
int flag_Penultimo=0;
int flag_AntePenultimo=0;
			...
			if(flagH){
				if(!flag2 && !flag3 && !flag4 && !flag5){
					for (x=0; x<30; x++){
						...
						intToString(osKernelSysTick()/120000, pbufx, 10, 10, 3);
						GrStringDraw(&sContext, "Tempo:", -1,(sContext.psFont->ui8MaxWidth)*2, (sContext.psFont->ui8Height+2)*5,true);
